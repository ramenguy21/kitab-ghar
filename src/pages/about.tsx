  ...
  return (
    <HomeLayout>
      <p className="italic my-2">
        Kitab Ghar is an entirely free, citizen-funded public library, situated
      ...
      <ul className="list-disc">
        ...
        <li>
          Our programming will reflect existing conversations but will not be a
          repetition of mainstream work (nuance and preciseness will be
          integral).{" "}
        </li>
        <li>
        ...
        <li>
          Our work will attempt to fill the silences in our archives; especially
          with regards to topics like state violence, community resistance,
          indigenous histories and protest memory.{" "}
        </li>
        <li>
          ...
          <ul>
            <li>
              ...
              places we might detract attention from more worthy voices because
              of the way celebrity culture works? Are we using our privileges
              without clear intention? Is oppression being exploited?{" "}
            </li>
            <li>
              <em>
        ...
        <li>
          We will always welcome critique, advice and input from our community,
          as long as it respects our labor and values our intent and efforts.
          But we will not welcome criticism for the sake of criticism.{" "}
        </li>
        <li>We reject all binaries of good and bad. </li>
        <li>
          Lastly, we will use any and all opportunities to celebrate and spread
          joy amidst the shitshow.
        </li>
      </ul>
    </HomeLayout>
  );
